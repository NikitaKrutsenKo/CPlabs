...
namespace ClassLibraryForLab4
{
    ...
    {
        public static void RunLab1(string inputFile, string outputFile)
        {
            try
            {
        ...
        private static string GetUserInput(string inputFile)
        {
        ...
        private static void ShowResult(int inputNumber, int numerator, int denominator)
        {
